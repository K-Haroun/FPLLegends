...
<template>
    ...
    <div
        class="flex flex-col justify-center items-center rounded-md sm:pb-8 pb-4 py-3 sm:pt-3 sm:w-60 w-40 border-1 border-gray-200 dark:border-gray-900 dark:bg-primary-foreground shadow-md dark:hover:bg-primary-foreground/60 cursor-pointer">
        ...
        <div class="flex justify-center items-center gap-3 sm:gap-5">
            ...
            <div>
                <p class="text-md sm:text-2xl font-bold">{{ topPlayer.name }}</p>
