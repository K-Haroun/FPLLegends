...
const teamImage = (team_id, team_name) =>
  `/images/teams/${team_id}_${safeName(team_name)}.png`;
</script>
    ...
    >
      <div class="flex gap-3 justify-center items-center">
        <div class="flex flex-col justify-center items-center gap-2">
          <img
            :src="teamImage(f.fixture.home_team.id, f.fixture.home_team.name)"
            alt="Player Team"
        ...
        <div class="flex flex-col justify-center items-center gap-2">
          <img
            :src="teamImage(f.fixture.away_team.id, f.fixture.away_team.name)"
            alt="Player Team"
            class="size-5 sm:size-8"
          />
        </div>
        ...
        <table class="border text-[8px] sm:text-base">
          ...
          <tbody>
            <tr>
              ...
              <td class="px-4 py-2 border">
                {{ performances[index].expected_goal_involvements }}
              </td>
              <td class="px-4 py-2 border">
                {{ performances[index].expected_goals_conceded }}
              </td>
