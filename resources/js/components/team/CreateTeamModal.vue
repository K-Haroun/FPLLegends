    ...
    <dialog id="my_modal_1" class="modal">
        <div class="modal-box">
            ...
            <form action="">
                <div class="flex flex-col gap-4">
                    <fieldset class="fieldset">
                        ...
                        <input v-model="teamName" type="text" class="input bg-blue-400/5" placeholder="Team name..." />
                    </fieldset>
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="grid grid-cols-4 justify-between text-center">
                            <div class="flex flex-col gap-2">
                                ...
                                <div>
                                    <div class="grid grid-flow-row grid-rows-4 gap-3 content-center">
                                        <div class="w-30 flex justify-center items-start" v-for="p in addedGk">
                                            <div class="flex flex-col justify-center items-center gap-1 pl-6">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="modal-action flex flex-col justify-start content-start">
                                                        ...
                                                        <form method="dialog" class="flex gap-3 justify-end">
                                                            ...
                                                            <button @click="saveTeam" class="btn btn-soft btn-success">
                                                                Save
                                                            </button>
                                                        </form>
                                                    </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div>
                                    <div class="grid grid-flow-row grid-rows-4 gap-4">
                                        <div class="w-30 flex justify-center items-start" v-for="p in addedDef">
                                            <div class="flex flex-col justify-center items-center gap-1 pl-6">
                                                <img :src="imageFile(p.fpl_id, p.name)" :alt="`${p.name} profile`"
                                                    @error="onImageError"
                                                    class="h-7 sm:h-10 border rounded-lg border-gray-100 bg-gray-100 px-1 pt-1" />
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div>
                                    <div class="grid grid-flow-row grid-rows-4 gap-4">
                                        <div class="w-30 flex justify-center items-start" v-for="p in addedMid">
                                            <div class="flex flex-col justify-center items-center gap-1 pl-6">
                                                <img :src="imageFile(p.fpl_id, p.name)" :alt="`${p.name} profile`"
                                                    @error="onImageError"
                                                    class="h-7 sm:h-10 border rounded-lg border-gray-100 bg-gray-100 px-1 pt-1" />
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div>
                                    <div class="grid grid-flow-row grid-rows-4 gap-4">
                                        <div class="w-30 flex justify-center items-start" v-for="p in addedFor">
                                            <div class="flex flex-col justify-center items-center gap-1 pl-6">
                                                <img :src="imageFile(p.fpl_id, p.name)" :alt="`${p.name} profile`"
                                                    @error="onImageError"
                                                    class="h-7 sm:h-10 border rounded-lg border-gray-100 bg-gray-100 px-1 pt-1" />
            ...
            <div class="modal-action">
                <form method="dialog" class="flex gap-3 justify-end">
                    <button class="btn btn-soft">Close</button>
                    <Link href="/userTeam" method="post" :data="userTeam">
                    <button onclick="create_team_modal.close()" class="btn btn-soft btn-success">
                        Create Team
                    </button>
                    </Link>
                </form>
